...
//there should be 5 arguments including the "./a3client"
if (argc !=5) {
...
strcpy(filename,argv[3]); //argv[3] is the one after IP and Port
 
fp = fopen(filename,"r");
fp2 = fopen(argv[4],"a"); //argv[4] is the one after command-file name
if(fp == NULL) {
